...
| Runtime bridge preflight | `01_content/gui-runtime-bridge-preflight-v1.md`. |
| Historical decision trace | `01_content/codex-session-snapshot.md` or named historical docs only when truly needed. |
...
| `01_content/ui-flow-blueprint.md` | core | CLI thin-layer to GUI flow mapping. |
| `01_content/gui-runtime-bridge-preflight-v1.md` | conditional | Runtime bridge preflight; read only for bridge planning. |
| `01_content/gui-bridge-vertical-slice-contract-audit-v1.md` | conditional | Bridge contract audit. |
| `01_content/gui-dynamic-traversal-continuity-v1-spec.md` | conditional | Traversal continuity semantics; not implementation approval by itself. |

### Screen / Facility Planning Docs

| File | Lifecycle | Role |
|---|---|---|
| `01_content/gui-facility-screen-template.md` | conditional | Facility screen model template. |
| `01_content/gui-guild-screen-visual-baseline.md` | conditional | Guild visual baseline. |
| `01_content/gui-guild-screen-model-draft.md` | conditional | Guild ScreenModel draft. |
| `01_content/gui-guild-screen-review-checklist.md` | conditional | Guild review checklist. |
| `01_content/gui-town-hub-screen-model-draft.md` | conditional | Town Hub ScreenModel draft. |
...
| File | Lifecycle | Role |
|---|---|---|
| `01_content/gui-implementation-platform-tradeoff.md` | historical | Platform tradeoff background; not a startup doc. |
| `01_content/codex-session-snapshot.md` | historical | Compact historical snapshot only when decision trace is needed. |
| `01_content/gui-ui-direction-brief.md` | archive candidate | Old GUI direction background; not a current entry doc. |
...
- `01_content/gui-html-town-hub-fixture-spec.md`
